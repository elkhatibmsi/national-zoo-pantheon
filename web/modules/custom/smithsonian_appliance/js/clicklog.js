(function($) {
   ...
   *
   * @see https://www.smithsonian.com/support/enterprise/static/gsa/docs/admin/70/gsa_doc_set/admin_searchexp/ce_improving_search.html#1034719
   */
  $(document).ready(function() {
    // Add a clickData function for clusters.
    Drupal.settings.smithsonian_appliance.clickTracking.clickData = function($element, clickType) {
    ...
    $('a').gsaClicks(Drupal.settings.smithsonian_appliance.clickTracking);
  });
