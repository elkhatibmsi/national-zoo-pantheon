...
namespace Drupal\Tests\smithsonian_appliance\Unit;

use Drupal\Core\Extension\ModuleHandlerInterface;
use Drupal\smithsonian_appliance\Service\Parser;
...
class ParserTest extends UnitTestCase {
  ...
  public function testParsing() {
    ...
    /** @var \Drupal\smithsonian_appliance\SearchResults\Result $result */
