...
class OneBoxResultSet {
   ...
   * Results.
   *
   * @var \Drupal\smithsonian_appliance\SearchResults\OneBoxResult[]
   */
  protected $results = [];
   ...
   * Adds a result.
   *
   * @param \Drupal\smithsonian_appliance\SearchResults\OneBoxResult $result
   *   The result.
   *
   * @return $this
   */
   ...
   *
   * @return \Drupal\smithsonian_appliance\SearchResults\OneBoxResult[]
   *   Value of results
   */
