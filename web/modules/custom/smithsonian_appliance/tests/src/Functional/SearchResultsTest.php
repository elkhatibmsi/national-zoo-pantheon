 ...
 */
class SearchResultsTest extends SmithsonianApplianceFunctionalTestBase {

  /**
   * {@inheritdoc}
   */
  protected static $modules = [
    'smithsonian_appliance_test',
  ];
  ...
  public function testSearchResults() {
    ...
    $config = $this->container->get('config.factory')->getEditable('smithsonian_appliance.settings');
    $config
